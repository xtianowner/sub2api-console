...
export const copy = {
  zh: {
    ...
    upstreamTitle: '中转接入', upstreamDesc: '一个上游 base_url + 多档 key，逐档建 upstream 账号并绑分组。', upstreamBaseUrl: '上游 Base URL', upstreamTiers: '档位(每行: 分组名,api_key,倍率)',
    // 设置
  ...
  en: {
    ...
    upstreamTitle: 'Upstream import', upstreamDesc: 'One upstream base_url + tiers; create upstream accounts and bind groups.', upstreamBaseUrl: 'Upstream Base URL', upstreamTiers: 'Tiers (each line: group,api_key,rate)',
